            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form  method="post"  action='<c:url value="/rentalAction!uploadRental.action"></c:url>'  class="form-horizontal"   target="J_iframe">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                	<input id="start" name="startDate" class="form-control layer-date" placeholder="开始日期">
                                </div>
                                <div class="col-sm-1">
                                	<hr/>
                                </div>
                                <div class="col-sm-2">
                                	<input id="end" name="endDate" class="form-control layer-date" placeholder="结束日期">
                                </div>
                            </div>
