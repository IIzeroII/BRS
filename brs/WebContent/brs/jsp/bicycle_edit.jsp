            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" enctype="multipart/form-data" action='<c:url value="/bicycleAction!editBicycle.action"></c:url>'  class="form-horizontal"   target="J_iframe">
                            <div class="form-group" style="display: none;">
                                <label class="col-sm-2 control-label">状态</label>

                                <div class="col-sm-5">
                                    <input name="status" type="text" class="form-control" value="${bicycle.status }">
                                </div>
                            </div>
                            <div class="form-group" style="display: none;">
                                ...
                                <div class="col-sm-5">
                                    <input name="bicId" type="text" class="form-control" value="${bicycle.bicId }">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input name="type" type="text" class="form-control" value="${bicycle.type }">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input name="price" type="text" class="form-control" value="${bicycle.price }">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-4">
                                    ...
                                    <button onclick="window.location.href='<c:url value='/bicycleAction!bicycleList.action'></c:url>'" class="btn btn-white" type="button">取消</button>
                                </div>
                            </div>
                        </form>
                    </div>
